	...
	public void actionPerformed(ActionEvent e) {
		...
		// 사용자가 사용중지(컴퓨터 종료 등) 할 때
			...
			try {
				...
				int pc = Integer.valueOf(FrameManger.getHomeFrame().getLoginPanel().getPcNumber());
				MyClientSocket.getClientSocket().off(pc);
				MyClientSocket.getClientSocket().socketClose();
